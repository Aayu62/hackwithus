...
export default function Hero({ onExploreClick }) {
  return (
    <section className="relative overflow-hidden pt-16 pb-20 md:pt-24 md:pb-28 border-b-2 border-black bg-white">
      
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        
        {/* Top Tagline Badge */}
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-brand-yellow text-black border-2 border-black font-mono text-xs font-black uppercase tracking-widest mb-6 shadow-neo">
          <Flame className="w-4 h-4 fill-black" />
          The Ultimate Hackathon & Event Hub
        </div>

        {/* Hero Title */}
        <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-black max-w-5xl mx-auto leading-none uppercase mb-6">
          Innovate. <span className="bg-brand-yellow px-3 py-1 border-2 border-black shadow-neo inline-block my-1">Compete.</span> Grow.
        </h1>

        {/* Hero Description */}
        <p className="font-body text-zinc-800 text-base sm:text-xl max-w-3xl mx-auto mb-10 leading-relaxed font-semibold">
